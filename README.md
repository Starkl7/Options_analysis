...
For historical option chain -
  Explored dolthub, but major data chunks for historical option chains missing. Will explore cronjobs pulling yfinance option chain data every hour (9:00 - 17:00 24*5)
